...
import { Scale, Swords, Shield, TrendingUp, TrendingDown, Gavel, Send, FileSearch, ScrollText } from "lucide-react";
...
const API_URL = "http://localhost:5000/debate";
...
export default function Courtroom() {
  ...
  async function presentCase() {
    ...
    setStage("round1");
    stageTimer.current = setTimeout(() => setStage("round2"), 1100);
    stageTimer.current = setTimeout(() => setStage("evidence"), 2200);
    stageTimer.current = setTimeout(() => setStage("verdict-loading"), 3300);
    stageTimer.current = setTimeout(() => setStage("done"), 4600);
  }
